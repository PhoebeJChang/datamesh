...
export const loader = async ({ params }) => {
  ...
  try {
    ...
    return redirect('/dashboard/all-users-mysql');
  }
};
export const action = async ({ request, params }) => {
  ...
  try {
    await customFetch.patch(`/showUserMySQL/${params.id}`, data);
...
const EditUserMySQL = () => {
  ...
  return <Wrapper>
    <Form method='post' className='form'>
      <h4 className='form-title'>edit user from mysql</h4>
